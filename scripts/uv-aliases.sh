...
# 环境管理器别名
alias uv-create="$SCRIPT_DIR/uv-env-manager.sh create"
alias uv-list="$SCRIPT_DIR/uv-env-manager.sh list"
alias uv-remove="$SCRIPT_DIR/uv-env-manager.sh remove"
alias uv-info="$SCRIPT_DIR/uv-env-manager.sh info"
alias uv-install="$SCRIPT_DIR/uv-env-manager.sh install"
alias uv-run="$SCRIPT_DIR/uv-env-manager.sh run"
alias uv-switch="$SCRIPT_DIR/uv-env-manager.sh switch"
alias uv-current="$SCRIPT_DIR/uv-env-manager.sh current"

# 快速环境切换别名
alias uv-dev="source $SCRIPT_DIR/uv-switch.sh dev"
alias uv-test="source $SCRIPT_DIR/uv-switch.sh test"
alias uv-prod="source $SCRIPT_DIR/uv-switch.sh prod"
alias uv-exp="source $SCRIPT_DIR/uv-switch.sh exp"
